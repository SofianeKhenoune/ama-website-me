...
export default function SideNav() {
  ...
  return (
    <div
      className={`sidenav h-screen px-3 py-4 md:px-3 bg-sideNavColor fixed w-full flex flex-col md:relative transition-transform duration-500 md:translate-x-0 ${
